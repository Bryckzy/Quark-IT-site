        ...
        <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-black/50 backdrop-blur-lg shadow-lg' : 'bg-transparent'}`}>
            <nav className="container mx-auto px-6 md:px-12 py-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center space-x-4">
                    ...
                    <a href="#servicos" className={navLinkClasses}>Nossos Serviços</a>
                    <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 text-white font-semibold py-2 px-5 rounded-full transition-all duration-300 flex items-center gap-2">
                        <img src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/whatsapp-white-icon.png" alt="WhatsApp" className="h-5 w-5" /> Fale com a Gente
                    </a>
                </div>
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-black/80 backdrop-blur-lg pb-4">
                    ...
                    <a href="#servicos" className={`block text-center ${navLinkClasses}`} onClick={() => setIsMenuOpen(false)}>Nossos Serviços</a>
